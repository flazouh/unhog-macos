...
struct PreferencesTests {
    ...
    func sensitivityPresets() {
        var quiet = CulpritPreferences.recommended
        quiet.monitoring.sensitivity = .quiet
        var early = CulpritPreferences.recommended
    ...
    func migratesNotificationChoice() throws {
        let suiteName = "CulpritPreferencesTests-\(UUID().uuidString)"
